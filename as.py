...
instruction_set = {
    ...
    "ADD":  {"opcode": "addOpc", "type": "three_reg", "expected_count": 4},
    "SUB":  {"opcode": "subOpc", "type": "three_reg", "expected_count": 4},
    "MUL":  {"opcode": "mulOpc", "type": "three_reg", "expected_count": 4},
    "DIV":  {"opcode": "divOpc", "type": "three_reg", "expected_count": 4},
    "LDR":  {"opcode": "ldrOpc", "type": "three_reg", "expected_count": 4},
    "STR":  {"opcode": "strOpc", "type": "three_reg", "expected_count": 4},
    "AND":  {"opcode": "andOpc", "type": "three_reg", "expected_count": 4},
    "ORR":  {"opcode": "orrOpc", "type": "three_reg", "expected_count": 4},
    "XOR":  {"opcode": "xorOpc", "type": "three_reg", "expected_count": 4},
    "LSL":  {"opcode": "lslOpc", "type": "three_reg", "expected_count": 4},
    "LSR":  {"opcode": "lsrOpc", "type": "three_reg", "expected_count": 4},
    "ASR":  {"opcode": "asrOpc", "type": "three_reg", "expected_count": 4},
